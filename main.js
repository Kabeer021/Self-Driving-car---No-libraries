...
function animate(time)
{
    for(let i = 0 ; i<traffic.length ; i++)
    {
        ...
        // Not passing anything as traffic cars my get damaged by themselves
    }
    ...
    bestCar = cars.find(
        c => c.y == Math.min(
            ...cars.map(c => c.y)
            // Array with y values of th cars
        ));
    ...
    carCtx.save();
    //To make sure car is not on the top of screen
